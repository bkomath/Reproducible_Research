...
```{r echo = TRUE}
#setwd("C:/Coursera/DataScience/ReproducibleResearch/Project")
```
...
```{r, echo= TRUE} 
activity <- read.csv("C:/Coursera/DataScience/ReproducibleResearch/Project/activity.csv")
...
>* The mean of the number of steps taken per day is ```r Mean_Of_TotalSteps```.

>* The median of the number of steps taken per day is ```r Median_Of_TotalSteps```.
...
The time is **```r tmax ```** minutes at **```r th```** th steps.
------
...
=======
>>>>>>> ec8d9d98b5ebce4adbb164691088848fc71dfb01
